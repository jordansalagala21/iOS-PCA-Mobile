...
export function AppointmentsScreen() {
  ...
  const upcoming = appointments.filter(
    (a) =>
      (a.status === "pending" || a.status === "in-progress") && a.date >= today,
  );
  ...
  const renderUpcomingCard = (appt: ApptDoc) => {
    ...
    const vehicleLine = [appt.vehicleDetails, appt.vehicleColor]
      .filter(Boolean)
      .join(" · ");
    return (
        ...
        <View style={styles.cardHeader}>
          ...
          >
            <Text
              style={
                appt.type === "biweekly"
                  ? styles.typeBadgeBiweeklyText
                  : styles.typeBadgeOneTimeText
              }
            >
      ...
      <View key={appt.id} style={styles.card}>
        ...
        <View style={styles.cardFooterSimple}>
          <Text style={isCharged ? styles.chargedText : styles.estText}>
            {isCharged
              ? `Charged: $${appt.actualCharge}`
              : `Est. $${appt.estimatedPrice}`}
          </Text>
        </View>
      </View>
    );
        ...
        <View style={styles.container}>
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyBody}>
              Your upcoming and past appointments will appear here once you book
              a service.
            </Text>
          </View>
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  inlineBookLink: { fontSize: 14, fontWeight: "700", color: "#E09010" },
  ...
  serviceName: { fontSize: 15, fontWeight: "700", color: "#0A0A0A", flex: 1 },
